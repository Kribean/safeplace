...
export const CardBlog = ({id,title,description,nbrOfLike,isMale,isFemale,keywords,numberOfComments,thematic})=>{
...
<CardHeader>
          ...
          <CardDescription className={"text-xs lg:text-md line-clamp-3 lg:line-clamp-5"}>{description}</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Badge variant="outline"><MessageSquareMore/>{numberOfComments}</Badge>
        </CardFooter>
</Link>
      </Card>
    )
